                                                ...
                                                @foreach($lang as $langs)
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="margin: 10px"
                                                            ...
                                                            <input name="title_{{$langs->lang}}"
                                                                   class="form-control baslik{{$langs->id}}"
                                                                   id="validationCustom01" type="text"
                                                                   placeholder="{{$langs->langName}} Başlık Giriniz">
                                                        </div>
                                                    </div>
                                                    <br>
                                                @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="avatar-upload">
                                                        <div class="avatar-edit">
                                                            <input name="image_{{$langs->lang}}" type='file'
                                                                   id="imageUpload{{$langs->id}}"
                                                                   accept=".png, .jpg, .jpeg"/>

    ...
    <div class="page-body">
        <div class="container-fluid container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Slider Listeleme Sayfası</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Aansayfa</a></li>
                            <li class="breadcrumb-item">Slider</li>
                            <li class="breadcrumb-item active">Slider Listeleme</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                        <!-- Bookmark Start-->
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Slider Sayısı</span>
                                        <h4 class="mb-0 counter">{{$slider->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Slider</span>
                                        <h4 class="mb-0 counter">{{$slider->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Slider</span>
                                        <h4 class="mb-0 counter">{{$slider->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('slider.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Slider Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($slider as $sliders)
                                        <tr class="tr-check" data-id="{{$sliders->lang_id}}" data-status="{{$sliders->status}}">
                                            <td><a target="_blank" href="{!! $sliders->link !!}" >{{$sliders->title}}</a></td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$sliders->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($sliders->created_at)->day }} {{ \Carbon\Carbon::parse($sliders->created_at)->monthName }} {{ \Carbon\Carbon::parse($sliders->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($sliders->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('slider.edit',$sliders->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('slider.destroy',$sliders->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Slider Durumu Aktif" : "Slider Durumu Pasif")

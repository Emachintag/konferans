                        ...
                        <div class="card">
                            ...
                            <div class="card-body add-post">
                                ...
                                <form class="row needs-validation" method="post" autocomplete="off"
                                      enctype="multipart/form-data" action="{{route('hizmet.store')}}">
                                    @csrf
                                    <div class="col-sm-12">
                                                ...
                                                @foreach($lang as $langs)
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="margin: 10px"
                                                            ...
                                                            <input  name="url_{{$langs->lang}}" class="form-control url{{$langs->id}}"
                                                                    id="slug-target" type="text"
                                                                    placeholder="{{$langs->langName}} URL Alanı Otomatik Oluşturuluyor"
                                                            ></div>
                                                    </div>
                                                    <br>
                                                @endforeach
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @foreach($lang as $langs)
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="margin: 10px"
                                                                                         class="flag-icon flag-icon-{{$langs->lang}}"></i>
                                                            <input name="title_2_{{$langs->lang}}" class="form-control"
                                                                   id="validationCustom01" type="text"
                                                                   placeholder="{{$langs->langName}} Alt Başlık Giriniz"
                                                            ></div>
                                                    </div>
                                                    <br>
                                                @endforeach
                                            ...
                                            @foreach($lang as $langs)
                                                <div class="col-md-6">
                                                    <div class="avatar-upload">
                                                        ...
                                                        <i style="margin: 10px"
                                                           class="flag-icon flag-icon-{{$langs->lang}}"></i>
                                                        <label>Hizmet Kapak Fotoğraf:</label>

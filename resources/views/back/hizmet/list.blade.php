                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Hizmet Sayısı</span>
                                        <h4 class="mb-0 counter">{{$hizmet->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Hizmet</span>
                                        <h4 class="mb-0 counter">{{$hizmet->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Hizmet Sayısı</span>
                                        <h4 class="mb-0 counter">{{$hizmet->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('hizmet.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Hizmet Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($hizmet as $hizmetler)
                                        <tr class="tr-check" data-id="{{$hizmetler->lang_id}}" data-status="{{$hizmetler->status}}">
                                            <td>{{$hizmetler->title}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$hizmetler->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($hizmetler->created_at)->day }} {{ \Carbon\Carbon::parse($hizmetler->created_at)->monthName }} {{ \Carbon\Carbon::parse($hizmetler->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($hizmetler->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('hizmet.edit',$hizmetler->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('hizmet.destroy',$hizmetler->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Hizmet Durumu Aktif" : "Hizmet Durumu Pasif")

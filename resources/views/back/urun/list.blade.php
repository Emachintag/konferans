                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Ürün Sayısı</span>
                                        <h4 class="mb-0 counter">{{$urun->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Ürün</span>
                                        <h4 class="mb-0 counter">{{$urun->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Ürün Sayısı</span>
                                        <h4 class="mb-0 counter">{{$urun->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('urun.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Ürün Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($urun as $uruns)
                                        <tr class="tr-check" data-id="{{$uruns->lang_id}}" data-status="{{$uruns->status}}">
                                            <td>{{$uruns->title}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$uruns->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($uruns->created_at)->day }} {{ \Carbon\Carbon::parse($uruns->created_at)->monthName }} {{ \Carbon\Carbon::parse($uruns->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($uruns->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('urun.edit',$uruns->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('urun.destroy',$uruns->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>

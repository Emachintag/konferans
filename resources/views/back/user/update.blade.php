    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Kullanıcı Ekleme Sayfası</h3>
                        <ol class="breadcrumb">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input value="{{$user->name}}" name="name" class="form-control" id="validationCustom01" type="text" placeholder="İsim Giriniz"></div>
                                                </div>
                                                <br>
                                                <label for="validationCustom01">E-Posta:</label>
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input value="{{$user->email}}" name="email" class="form-control" id="validationCustom01" type="text" placeholder="E-Posta Giriniz"></div>
                                                </div>
                                                <br>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input value="{{$user->last_name}}" name="last_name" class="form-control" id="validationCustom01" type="text" placeholder="Soyisim Giriniz"></div>
                                                </div>
                                                <br>
                                            ...
                                            <div class="col-md-12">
                                                <div class="containers">
                                                    <div class="imageWrapper">
                                                        <img class="image" src="{{asset('public/'.$user->image)}}">
                                                    </div>
                                                </div>

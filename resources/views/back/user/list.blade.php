                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Kullanıcı Sayısı</span>
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Kullanıcı</span>
                                        <h4 class="mb-0 counter">{{$user->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Kullanıcı</span>
                                        <h4 class="mb-0 counter">{{$user->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('user.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Kullanıcı Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($user as $users)
                                            <tr class="tr-check" data-id="{{$users->id}}" data-status="{{$users->status}}">
                                            <td>{{$users->name}}</a></td>
                                            <td>{{$users->last_name}}</a></td>
                                            <td>{{$users->email}}</a></td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$users->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($users->created_at)->day }} {{ \Carbon\Carbon::parse($users->created_at)->monthName }} {{ \Carbon\Carbon::parse($users->created_at)->year }}</td>
                                            ...
                                            <td style="text-align: center" >
                                                <a href="{{route('user.edit',$users->id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('user.destroy',$users->id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Kullanıcı Durumu Aktif" : "Kullanıcı Durumu Pasif")

                        ...
                        <div class="card">
                            ...
                            <div class="card-body add-post">
                                ...
                                <form class="row needs-validation" method="post" autocomplete="off"
                                      enctype="multipart/form-data" action="{{route('belge.store')}}">
                                    @csrf
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col mb-2">
                                                    <i style="margin: 10px" class="flag-icon flag-icon-{{$langs->lang}}"></i> <input name="pdf_{{$langs->lang}}" class="btn btn-pill btn-primary" type="file" id="pdf-upload" accept="application/pdf"/>
                                                </div>
                                                @endforeach

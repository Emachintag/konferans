                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Toplam Kategori</span>
                                        <h4 class="mb-0 counter">{{$blogcategory->count()}}</h4><i class="icon-bg"
                            ...
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Kategori</span>
                                        <h4 class="mb-0 counter">{{$blogcategory->where('status',0)->count()}}</h4><i class="icon-bg"
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Kategori</span>
                                        <h4 class="mb-0 counter">{{$blogcategory->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('blog-category.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Blog Kategori Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($blogcategory as $blogcategorys)
                                        ...
                                        <tr class="tr-check" data-id="{{$blogcategorys->lang_id}}" data-status="{{$blogcategorys->status}}">
                                            <td>{{$blogcategorys->kategori}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$blogcategorys->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($blogcategorys->created_at)->day }} {{ \Carbon\Carbon::parse($blogcategorys->created_at)->monthName }} {{ \Carbon\Carbon::parse($blogcategorys->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($blogcategorys->status) checked @endif>
                                                    <span class="slider round"></span>

                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('blog-category.edit',$blogcategorys->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('blog-category.destroy',$blogcategorys->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Blog Kategori Durumu Aktif" : "Blog Kategori Durumu Pasif")

    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Etiket Ekleme ve Silme Sayfası</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Aansayfa</a></li>
                            <li class="breadcrumb-item">Etiket Ekleme ve Silme Sayfası</li>
                        </ol>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body add-post">
                                ...
                                <form class="row needs-validation" method="post" autocomplete="off"
                                      enctype="multipart/form-data" action="{{route('etiket.store')}}">
                                    @csrf
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input  name="title" class="form-control" id="validationCustom01" type="text" placeholder="Başlık Giriniz"></div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <table id="example" class="table table-hover responsive nowrap" style="width:100%">
                                                                ...
                                                                @foreach($etiket as $etikets)
                                                                    <tr class="tr-check" data-id="{{$etikets->id}}" data-status="{{$etikets->status}}">
                                                                        <td>
                                                                            <a href="#">
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="">
                                                                                        <p class="font-weight-bold mb-0">{{$etikets->title}}</p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </td>
                                                                        <td><label class="switch">
                                                                                <input type="checkbox" class="checkk"
                                                                                       @if($etikets->status) checked @endif>
                                                                        ...
                                                                        <td style="text-align: center" >
                                                                            <a href="{{route('etiket.destroy',$etikets->id)}}" class="btn btn-pill btn-danger-gradien " type="button"><i class="fa fa-trash"></i></a>
                                                                        </td>
                                                                        @endforeach
                                                                    </tr>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Etiket Durumu Aktif" : "Etiket Durumu Pasif")

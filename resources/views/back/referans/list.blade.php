                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Referans Sayısı</span>
                                        <h4 class="mb-0 counter">{{$referans->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Referans</span>
                                        <h4 class="mb-0 counter">{{$referans->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Referans</span>
                                        <h4 class="mb-0 counter">{{$referans->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('referans.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Referans Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($referans as $referanslar)
                                        <tr class="tr-check" data-id="{{$referanslar->lang_id}}" data-status="{{$referanslar->status}}">
                                            <td><a target="_blank" href="{!! $referanslar->link !!}" >{{$referanslar->title}}</a></td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$referanslar->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($referanslar->created_at)->day }} {{ \Carbon\Carbon::parse($referanslar->created_at)->monthName }} {{ \Carbon\Carbon::parse($referanslar->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($referanslar->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('referans.edit',$referanslar->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('referans.destroy',$referanslar->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Referans Durumu Aktif" : "Referans Durumu Pasif")

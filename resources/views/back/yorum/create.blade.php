                        ...
                        <div class="card">
                            ...
                            <div class="card-body add-post">
                                ...
                                <form class="row needs-validation" method="post" autocomplete="off"
                                      enctype="multipart/form-data" action="{{route('yorum.store')}}">
                                    @csrf
                                    <div class="col-sm-12">
                                                ...
                                                @foreach($lang as $langs)
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="margin: 10px" class="flag-icon flag-icon-{{$langs->lang}}"></i>
                                                            <input  name="title_{{$langs->lang}}" class="form-control baslik{{$langs->id}}" id="validationCustom01" type="text" placeholder="{{$langs->langName}} İsim Giriniz"></div>
                                                    </div>
                                                    <br>
                                                @endforeach
                                            </div>
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="margin: 10px"
                                                            ...
                                                            <input name="title_2_{{$langs->lang}}" class="form-control"
                                                                   ...
                                                                   placeholder="{{$langs->langName}} Ünvan Giriniz"
                                                                   ></div>
                                                    </div>
                                                    <br>
                                                @endforeach

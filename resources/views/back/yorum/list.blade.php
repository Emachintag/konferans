        ...
        <div class="container-fluid container-fluid">
            ...
            <div class="container-fluid general-widget">
                <div class="row">
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Toplam Yorum Sayısı</span>
                                        <h4 class="mb-0 counter">{{$yorum->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Yorum Sayısı</span>
                                        <h4 class="mb-0 counter">{{$yorum->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Yorum Sayısı</span>
                                        <h4 class="mb-0 counter">{{$yorum->where('status',1)->count()}}</h4><i class="icon-bg"
                    ...
                    <div class="col-sm-6 col-xl-3 col-lg-6">
                        <div class="card o-hidden border-0">
                            <a href="{{route('yorum.create')}}" >
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="file-plus"></i></div>
                                    <div class="media-body"><span class="m-0">Yorum Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($yorum as $yorums)
                                        <tr class="tr-check" data-id="{{$yorums->lang_id}}" data-status="{{$yorums->status}}">
                                            <td>{{$yorums->title}}</td>
                                            <td>{{$yorums->title_2}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$yorums->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($yorums->created_at)->day }} {{ \Carbon\Carbon::parse($yorums->created_at)->monthName }} {{ \Carbon\Carbon::parse($yorums->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($yorums->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('yorum.edit',$yorums->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('yorum.destroy',$yorums->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>

        ...
        <div class="container-fluid container-fluid">
            ...
            <div class="container-fluid general-widget">
                <div class="row">
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Toplam S.S.S Sayısı</span>
                                        <h4 class="mb-0 counter">{{$soru->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Blog Sayısı</span>
                                        <h4 class="mb-0 counter">{{$soru->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif S.S.S Sayısı</span>
                                        <h4 class="mb-0 counter">{{$soru->where('status',1)->count()}}</h4><i class="icon-bg"
                    ...
                    <div class="col-sm-6 col-xl-3 col-lg-6">
                        <div class="card o-hidden border-0">
                            <a href="{{route('soru.create')}}" >
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="file-plus"></i></div>
                                    <div class="media-body"><span class="m-0">S.S.S Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display" id="basic-2">
                                    ...
                                    @foreach($soru as $sorular)
                                        <tr class="tr-check" data-id="{{$sorular->lang_id}}" data-status="{{$sorular->status}}">
                                            <td>{{$sorular->title}}</td>
                                            <td>{!! $sorular->text !!}</td>
                                            <td>{{ \Carbon\Carbon::parse($sorular->created_at)->day }} {{ \Carbon\Carbon::parse($sorular->created_at)->monthName }} {{ \Carbon\Carbon::parse($sorular->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($sorular->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('soru.edit',$sorular->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('soru.destroy',$sorular->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "S.S.S Durumu Aktif" : "S.S.S Durumu Pasif")

                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Haber Listeleme</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                        <!-- Bookmark Start-->
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Haber Sayısı</span>
                                        <h4 class="mb-0 counter">{{$haber->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Haber</span>
                                        <h4 class="mb-0 counter">{{$haber->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Haber Sayısı</span>
                                        <h4 class="mb-0 counter">{{$haber->where('status',1)->count()}}</h4><i class="icon-bg"
                            ...
                            <a href="{{route('haber.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body"><span class="m-0">Haber Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($haber as $habers)
                                        <tr class="tr-check" data-id="{{$habers->lang_id}}" data-status="{{$habers->status}}">
                                            <td>{{$habers->title}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$habers->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($habers->created_at)->day }} {{ \Carbon\Carbon::parse($habers->created_at)->monthName }} {{ \Carbon\Carbon::parse($habers->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($habers->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('haber.edit',$habers->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('haber.destroy',$habers->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Haber Durumu Aktif" : "Haber Durumu Pasif")

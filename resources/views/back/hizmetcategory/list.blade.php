        ...
        <div class="container-fluid container-fluid">
            ...
            <div class="container-fluid general-widget">
                <div class="row">
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Toplam Kategori</span>
                                        <h4 class="mb-0 counter">{{$hizmetcategory->count()}}</h4><i class="icon-bg"
                            ...
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Kategori</span>
                                        <h4 class="mb-0 counter">{{$hizmetcategory->where('status',0)->count()}}</h4><i class="icon-bg"
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Kategori</span>
                                        <h4 class="mb-0 counter">{{$hizmetcategory->where('status',1)->count()}}</h4><i class="icon-bg"
                    ...
                    <div class="col-sm-6 col-xl-3 col-lg-6">
                        <div class="card o-hidden border-0">
                            <a href="{{route('hizmet-category.create')}}" >
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        <div class="align-self-center text-center"><i data-feather="file-plus"></i></div>
                                        <div class="media-body"><span class="m-0">Hizmet Kategori Ekle</span>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Hizmet Kategori Listeleme</h5>
                        </div>
                        <div class="card-body ">
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($hizmetcategory as $hizmetcategorys)
                                        ...
                                        <tr class="tr-check" data-id="{{$hizmetcategorys->lang_id}}" data-status="{{$hizmetcategorys->status}}">
                                            <td>{{$hizmetcategorys->kategori}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$hizmetcategorys->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($hizmetcategorys->created_at)->day }} {{ \Carbon\Carbon::parse($hizmetcategorys->created_at)->monthName }} {{ \Carbon\Carbon::parse($hizmetcategorys->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($hizmetcategorys->status) checked @endif>
                                                    <span class="slider round"></span>

                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('hizmet-category.edit',$hizmetcategorys->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('hizmet-category.destroy',$hizmetcategorys->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
...
@section('js')
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                url: "{{route('hizmet-category.status')}}",
                method: "post",
                headers: {
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Hizmet Kategori Durumu Aktif" : "Hizmet Kategori Durumu Pasif")

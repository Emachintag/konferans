    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Hizmet Kategori Ekleme Sayfası</h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body add-post">
                                ...
                                <form class="row needs-validation" method="post" autocomplete="off"
                                      enctype="multipart/form-data" action="{{route('hizmet-category.store')}}">
                                    @csrf
                                    <div class="col-sm-12">
                                                ...
                                                @foreach($lang as $langs)
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i style="margin: 10px" class="flag-icon flag-icon-{{$langs->lang}}"></i>
                                                            <input  name="kategori_{{$langs->lang}}" class="form-control baslik{{$langs->id}}" id="validationCustom01" type="text" placeholder="{{$langs->langName}} Başlık Giriniz"></div>
                                                    </div>
                                                    <br>
                                                @endforeach
                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <select class="js-example-basic-single col-sm-12 select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="kategori_tree">
                                                        <optgroup label="Kategoriler">
                                                            ...
                                                            <option value="{{$hizmetcategorys->id}}">{{$hizmetcategorys->kategori}}</option>
                                                            @endforeach
                                                        </optgroup>
                                                    </select>
                                                </div>

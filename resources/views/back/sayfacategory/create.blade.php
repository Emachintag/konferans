                        ...
                        <div class="card">
                            ...
                            <div class="card-body add-post">
                                ...
                                <form class="row needs-validation" method="post" autocomplete="off"
                                      enctype="multipart/form-data" action="{{route('sayfa-category.store')}}">
                                    @csrf
                                    <div class="col-sm-12">
                                                ...
                                                <label for="validationCustom01">Başlık:</label>
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <input  name="kategori" class="form-control" id="validationCustom01" type="text" placeholder="Başlık Giriniz"></div>
                                                    </div>
                                                    <br>
                                                ...
                                                <div>
                                                    ...
                                                    <select class="js-example-basic-single col-sm-12 select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="kategori_tree">
                                                        <optgroup label="Kategoriler">
                                                            ...
                                                            <option value="{{$sayfacategorys->id}}">{{$sayfacategorys->kategori}}</option>
                                                            @endforeach
                                                        </optgroup>
                                                    </select>
                                                </div>

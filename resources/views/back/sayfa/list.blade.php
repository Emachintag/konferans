                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Toplam Sayfa Sayısı</span>
                                        <h4 class="mb-0 counter">{{$sayfa->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Sayfa Sayısı</span>
                                        <h4 class="mb-0 counter">{{$sayfa->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Sayfa Sayısı</span>
                                        <h4 class="mb-0 counter">{{$sayfa->where('status',1)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Sayfa Ekle</span>
                        ...
                        <div class="card-body ">
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    <tbody>
                                    @foreach($sayfa as $sayfas)
                                        <tr class="tr-check" data-id="{{$sayfas->id}}" data-status="{{$sayfas->status}}">
                                            <td>{{$sayfas->title}}</td>
                                            @if($sayfas->type == 1)
                                            <td>Text Alanı</td>
                                            @else
                                                <td>Link</td>
                                            @endif
                                            <td>{{ \Carbon\Carbon::parse($sayfas->created_at)->day }} {{ \Carbon\Carbon::parse($sayfas->created_at)->monthName }} {{ \Carbon\Carbon::parse($sayfas->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($sayfas->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >

                                                <a href="{{route('sayfa.edit',$sayfas->id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('sayfa.destroy',$sayfas->id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
    ...
    <script>
        $(".checkk").change((e) => {
            ...
            $.ajax({
                ...
                success: function (d) {
                    toastr.success($(e.target).is(":checked") ? "Sayfa Durumu Aktif" : "Sayfa Durumu Pasif")

    ...
    <div class="page-body">
        <div class="container-fluid container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Blog Listeleme Sayfası</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Aansayfa</a></li>
                            <li class="breadcrumb-item">Blog</li>
                            <li class="breadcrumb-item active">Blog Listeleme</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                        <!-- Bookmark Start-->
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Toplam Blog Sayısı</span>
                                        <h4 class="mb-0 counter">{{$blog->count()}}</h4><i class="icon-bg"
                            ...
                            <div class="bg-danger b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Deaktif Blog Sayısı</span>
                                        <h4 class="mb-0 counter">{{$blog->where('status',0)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Aktif Blog Sayısı</span>
                                        <h4 class="mb-0 counter">{{$blog->where('status',1)->count()}}</h4><i class="icon-bg"
                        ...
                        <div class="card o-hidden border-0">
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body"><span class="m-0">Blog Ekle</span>
                            ...
                            <div class="table-responsive">
                                <table class="display " id="basic-2">
                                    ...
                                    @foreach($blog as $blogs)
                                        <tr class="tr-check" data-id="{{$blogs->lang_id}}" data-status="{{$blogs->status}}">
                                            <td>{{$blogs->title}}</td>
                                            <td style="text-align: center"><img style="border-radius: 10%" class="img"
                                                                                src="{{asset("public/".$blogs->image)}}"
                                                                                height="100"></td>
                                            <td>{{ \Carbon\Carbon::parse($blogs->created_at)->day }} {{ \Carbon\Carbon::parse($blogs->created_at)->monthName }} {{ \Carbon\Carbon::parse($blogs->created_at)->year }}</td>
                                            <td><label class="switch">
                                                    <input type="checkbox" class="checkk"
                                                           @if($blogs->status) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </td>
                                            <td style="text-align: center" >
                                                <a href="{{route('blog.edit',$blogs->lang_id)}}" class="btn btn-pill btn-info-gradien" type="button"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('blog.destroy',$blogs->lang_id)}}" class="btn btn-pill btn-danger-gradien" type="button"><i class="fa fa-trash"></i></a>
                                            </td>
